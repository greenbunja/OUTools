(function() {
	...
	chrome.storage.local.get("jjalsEnable", function(items) {
	...
	chrome.storage.local.get("remoconEnable", function(items) {
	...
	chrome.runtime.onMessage.addListener(function(message) {
		if (message.text == "lottery") {
			...
			offBGMs();
		} else if (message.text == "removeStyle") {
			$("#tail_layer style, contentContainer style").remove();
		}
	});
})();