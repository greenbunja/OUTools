function resetJjals(callback)
{
	chrome.storage.local.get("jjals", function(items) {
		var defaultJjals = ["http://i.imgur.com/cn7QOaW.png",
							...
							"http://i.imgur.com/kFAOb5m.png",
							"http://i.imgur.com/5XnWfLZ.png",
							"http://i.imgur.com/enLoyWR.png",
							"http://i.imgur.com/KHQe86E.png",
